...
{
    /// <summary>
    /// Exception thrown when an operation is performed on a bridge or device that has not been properly initialized.
    /// </summary>
    public class NotInitializedException : InvalidOperationException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotInitializedException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
