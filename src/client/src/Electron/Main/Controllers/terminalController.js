...
const shellMap = {
  win32: {
    bash: { path: 'C:\\Program Files\\Git\\usr\\bin\\bash.exe', args: ['--login'] },
...
/**
 * Get the platform-specific shell configuration from the platform and type.
...
const getPlatformShellFromType = (type) => {
  ...
  const shell = shellMap[platform][type];
