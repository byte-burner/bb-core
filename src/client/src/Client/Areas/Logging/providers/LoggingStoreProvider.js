...
export const LoggingStoreContext = createContext(null);

export function useLoggingStore() {
  return useContext(LoggingStoreContext);
}
...
export function LoggingStoreProvider() {
  ...
  return (
    <LoggingStoreContext.Provider value={store}>
      <Outlet />
    </LoggingStoreContext.Provider>
  );
}

LoggingStoreProvider.propTypess = {
